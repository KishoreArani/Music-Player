...
statusbar = ttk.Label(root,text="Welcome to Music Player",relief = SUNKEN,anchor=W,font='Times 15 bold')
...
def about_us():
    tkinter.messagebox.showinfo('our title','This music player is created using tkinter')
...
#root.iconbitmap('musicplayer.ico')
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('File not found','Music player cannot find a file')
...
mutephoto = PhotoImage(file='speakeroff.png')
